	...
	const faqs = [
		{
			...
			answer: "すぐに5クレジット分の無料トライアルを開始できます。クレジットカードの登録は不要です。",
		},
		{
			question: "1クレジットで何ができますか？",
			answer: "1クレジットで1回の画像生成、背景除去、または短時間のミュージック生成が可能です。画像のサイズや複雑さによって消費されるクレジット数が変わることはありません。",
		},
		{
			question: "生成された画像の著作権はどうなりますか？",
			answer: "AIStationで生成された画像の著作権は、生成したユーザーに帰属します。商用利用も可能です。ただし、他者の著作権を侵害するような使用は禁止されています。",
		},
		// {
