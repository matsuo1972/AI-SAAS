  ...
  const faqs = [
    {
      ...
      answer:
        "メールアドレスを登録するだけで、すぐに20クレジット分の無料トライアルを開始できます。クレジットカードの登録は不要です。",
    },
    {
      question: "1クレジットで何ができますか？",
      answer:
        "1クレジットで1回の画像生成、背景除去、または高品質な画像圧縮が可能です。画像のサイズや複雑さによって消費されるクレジット数が変わることはありません。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "JPG、PNG、WEBP、GIF、SVGなど、一般的な画像フォーマットに対応しています。出力フォーマットは用途に応じて選択可能です。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "はい。月額プランはいつでもキャンセル可能で、次回の更新日までサービスを利用できます。年間プランの場合は、未使用期間分が返金されます。",
    },
  ];
